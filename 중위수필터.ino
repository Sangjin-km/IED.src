...
// get a distance reading from the USS
  ...
  int ema2 = (num2[4] + num2[5])/2;
  num3[a3] = dist_raw;
  a3++;
  if (a3 >= 30){
    a3 = 0;
  }
  int ema3 = (num3[14] + num3[15])/2;
...
// output the read value to the serial port
  ...
  Serial.print(map(ema1,0,400,100,500));
  Serial.print(",");
  Serial.print("median10:");
  Serial.print(map(ema2,0,400,100,500));
  Serial.print(",");
  Serial.print("median30:");
  Serial.print(map(ema3,0,400,100,500));
  Serial.print(",");
